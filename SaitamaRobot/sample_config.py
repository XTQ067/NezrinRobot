...
class Config(object):
    ...
    API_ID = 11661168  # integer value, dont use ""
    API_HASH = "30cc640b6977480660e650f71d52d1ae"
    TOKEN = "5475133591:AAGj7tTDMk3vs5Aly5N1T28J57w8qLzgVls"  #This var used to be API_KEY but it is now TOKEN, adjust accordingly.
    OWNER_ID = 5573868756  # If you dont know, run the bot and do /id in your private chat with it, also an integer
    OWNER_USERNAME = "ismayilzadevuqar"
    SUPPORT_CHAT = 'NeonSUP'  #Your own group for support, do not add the @
    JOIN_LOGGER = -1001759926331  #Prints any new group the bot is added to, prints just the name and ID.
    EVENT_LOGS = -1001759926331  #Prints information like gbans, sudo promotes, AI enabled disable states that may help in debugging and shit
